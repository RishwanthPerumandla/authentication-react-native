            ...
            <Wrapper>
                ...
                >
                    ...
                    <View style={styles.inputContainerStyle}>
                        <TextInput
                            mode="outlined"
                            error = {!this._isMailIDValid(outlinedText)}
                            style={styles.inputContainerStyle}
                            label="Mail ID"
                            ref = {this.emailRef}
                    ...
                    <Button
                        ...
                        style = {!!(!this.state.username || !this.state.password || !this.state.email)?styles.buttonDisabled : styles.button}
                        disabled = {!!(!this.state.username || !this.state.password || !this.state.email)? true : false}
                        style={styles.button}
                        color ={"#FFFFFF"}
                        >
                        Sign Up
